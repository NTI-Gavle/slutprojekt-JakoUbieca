...
<body>
    ...
    <div class="forum-container">
        ...
        <div class="forum-header">
            ...
            <div class="forum-nav">
                <a href="create_thread.php?category_id=<?php echo $category_id; ?>" class="btn-forum btn-forum-primary">✏️ New Thread</a>
                <a href="index.php" class="btn-forum">← Back</a>
            </div>
        </div>
        ...
        <div class="glass-panel">
                        ...
                        <a href="thread.php?id=<?php echo $t['id']; ?>" class="<?php echo $card_class; ?>">
                            <div class="thread-info">
                                ...
                                <div class="thread-meta">
                                    <span>by <?php echo htmlspecialchars($t['username']); ?></span>
            ...
            <?php else: ?>
                <div class="empty-state">No threads in this category yet. Start one!</div>
            <?php endif; ?>
        </div>

    </div>

    <script>const categoryId = <?php echo $category_id; ?>;</script>
