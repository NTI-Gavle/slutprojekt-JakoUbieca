...
<body>
    ...
    <div class="forum-container">
        ...
        <div class="glass-panel">
            <h2 style="color: #fff; margin-top: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">✏️ Create New Thread</h2>
            <p style="color: rgba(255,255,255,0.7); margin-bottom: 25px;">Posting in: <?php echo htmlspecialchars($cat_icon . ' ' . $cat_name); ?></p>
            ...
            <form id="createThreadForm">
                ...
                <div style="display: flex; gap: 10px;">
                    <button type="submit" class="btn-forum btn-forum-primary">📤 Create Thread</button>
                    <a href="category.php?id=<?php echo $category_id; ?>" class="btn-forum">Cancel</a>
                </div>
            </form>
